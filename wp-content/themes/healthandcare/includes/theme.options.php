...
if ( !function_exists( 'healthandcare_options_settings_theme_setup' ) ) {
	...
	function healthandcare_options_settings_theme_setup() {
        ...
        "info_socials_4" => array(
                    "title" => esc_html__('Login via Social network', 'healthandcare'),
                    "desc" => esc_html__("Settings for the Login via Social networks", 'healthandcare'),
                    "type" => "info"),

        "social_login" => array(
                    "title" => esc_html__('Social plugin shortcode',  'healthandcare'),
                    "desc" => esc_html__('Social plugin shortcode like [plugin_shortcode]',  'healthandcare'),
                    "divider" => false,
                    "std" => "",
                    "type" => "text"),
        ...
        "info_service_3" => array(
                    "title" => esc_html__('API Keys', 'healthandcare'),
                    "desc" => wp_kses_data( __('API Keys for some Web services', 'healthandcare') ),
                    "type" => "info"),
        'api_google' => array(
                    "title" => esc_html__('Google API Key', 'healthandcare'),
                    "desc" => wp_kses_data( __("Insert Google API Key for browsers into the field above to generate Google Maps", 'healthandcare') ),
                    "std" => "",
                    "type" => "text"),
		);
