<div id="popup_login" class="popup_wrap popup_login bg_tint_light">
	...
	<div class="form_wrap">
		...
		<div class="form_right">
			...
			<?php
			$social_login = str_replace('[', '', healthandcare_get_theme_option('social_login'));
			...
			<?php } else {?>
				<div><?php _e("Install social plugin that has it's own SHORTCODE and add it to Theme Options - Socials - 'Login via Social network' field. We recommend: Wordpress Social Login", 'healthandcare'); ?></div>
			<?php }?>
