	...
	function healthandcare_messages_add_scripts_inline() {
		...
		echo '<script type="text/javascript">'
			...
			. 'HEALTHANDCARE_GLOBALS["strings"] = {'
				. 'ajax_error: 		    "' . addslashes(__('Invalid server answer', 'healthandcare')) . '",'
                ...
                . 'last_name_empty:			"' . addslashes(__('The last name can\'t be empty', 'healthandcare')) . '",'
                . 'last_name_long:			"' . addslashes(__('Too long last name', 'healthandcare')) . '",'
                ...
                . 'phone_empty:			"' . addslashes(__('Too short (or empty) phone number', 'healthandcare')) . '",'
                . 'phone_long:			"' . addslashes(__('Too long phone number', 'healthandcare')) . '",'
