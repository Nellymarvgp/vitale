...
//			vc_remove_element("vc_accordion_tab");
			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						"param_name" => "style",
						"heading" => esc_html__("Style 1", "healthandcare"),
						"description" => esc_html__("Select style of the contact form", "healthandcare"),
						"admin_label" => true,
						"class" => "",
						"value" => array(
                            esc_html__('Style 1', 'healthandcare') => 1,
                            esc_html__('Style 2', 'healthandcare') => 2,
                            esc_html__('Style 3', 'healthandcare') => 3
                        ),
						"type" => "dropdown"
					),
                    array(
                        "param_name" => "options",
                        "heading" => esc_html__("Select field  options", "healthandcare"),
                        "description" => esc_html__("Select field options. For example: big=My daddy|middle=My brother|small=My little sister", "healthandcare"),
//                        'dependency' => array(
//                            'element' => 'style',
//                            'value' => 3
//                        ),
