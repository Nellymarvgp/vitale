			...
			$HEALTHANDCARE_GLOBALS['shortcodes'] = array(
				...
				"trx_contact_form" => array(
					...
					"params" => array(
                        ...
                        "options" => array(
                            "title" => esc_html__("Select options", "healthandcare"),
                            "desc" => esc_html__("Select options. For example: big=My daddy|middle=My brother|small=My little sister", "healthandcare"),
                            "dependency" => array(
                                'style' => 3
                            ),
                            "value" => "",
